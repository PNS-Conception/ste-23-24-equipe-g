Feature: Operational Data Collection
  ...
  Scenario: Collecting order volume data
    ...
    Then the order volume data should be collected and stored
  ...
  Scenario: Collecting delivery efficiency data
    ...
    Then the delivery efficiency data should be collected and stored
  ...
  Scenario: Collecting popular menu item data
    ...
    Then the popularity data of the menu item should be collected and stored

  Scenario: Collecting user behavior data
    Given the system is interfacing with the user ordering platform
    When a user places an order
    Then the user's ordering behavior data should be collected and stored
