Feature: Restaurant Capacity Management
  ...
  Scenario: Placing an Order Within Capacity Limits
    ...
    And the capacity for "Campus Delight" is set to 50 meals for the 12:00 PM slot on 20th "NOVEMBER" 2023
    When a user tries to place an order for 35 meals at "Campus Delight" for 12:00 PM on 20th "NOVEMBER" 2023
  ...
  Scenario: Attempting to Place an Order Beyond Capacity Limits
    ...
    And the remaining capacity for "Campus Delight" at 1:00 PM on 21th November 2023 should still be 0 meals
