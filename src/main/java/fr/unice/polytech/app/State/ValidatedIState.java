...
/**
 * Represents the Validated state of an order in the system.
 * In this state, the order has been validated and cannot be modified further.
 */
public class ValidatedIState implements IState {
    ...
    /**
     * Throws an exception indicating that the order has already been marked as
     * ready.
     * 
    ...
    /**
     * Sets the status of the order to Delivered.
     * 
    ...
    public void delivery(Order order) throws Exception {
        order.setStatus(new DelivredIState());
    }
